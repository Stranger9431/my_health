...
from .views import RegisterView, UserProfileUpdateView, RequestPasswordResetView, PasswordResetConfirmView, UserProfileView, get_food_details, get_food_list, log_meal
...
urlpatterns = [
    ...
    path("api/password-reset/request/", RequestPasswordResetView.as_view(), name="password_reset_request"),
