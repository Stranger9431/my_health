# Generated by Django 5.1.6 on 2025-03-29 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hip_circ', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('portion_size', models.CharField(blank=True, choices=[('small', 'Small'), ('medium', 'Medium'), ('large', 'Large')], max_length=10, null=True)),
